...
参数列表
     1. 类型可推倒，
    	//  表达式中无需指定类型, 由编译器推断得出
    	Func fun = (args) -> System.out.println(args)
     2. 只有一个参数
    	小括号可以省略
     3. 没有参数
	    小括号不能省略
...
介绍
    /*
    	...
    	引用的方法，是其他地方已经定义过的方法，可以使用语法糖进行简写
    */
